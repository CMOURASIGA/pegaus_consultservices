...
const serverSchema = z.object({
  ...
  PEGASUS_AI_PROVIDER: z.enum(['fake', 'openai']).default('fake'),
  PEGASUS_AI_MODEL: z.string().min(1).default('gpt-5.6-luna'),
  PEGASUS_AI_MAX_OUTPUT_TOKENS: z.coerce.number().int().min(64).max(8_000).default(800),
