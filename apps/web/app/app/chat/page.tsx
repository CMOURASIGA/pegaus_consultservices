...
export default async function ChatPage({ searchParams }: { searchParams: Promise<{ conversation?: string; message?: string }> }) {
  ...
  return <ChatShell displayName={profile.display_name || 'Christian'} conversations={conversations} activeConversation={activeConversation} initialMessages={messages} initialDraft={initialDraft} />
}
