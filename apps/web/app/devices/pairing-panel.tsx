...
export function PairingPanel() {
  ...
  const requestPairing = async () => {
    ...
    try {
      ...
      setChallenge(body); setStatus('Código criado. Aprove este computador e então cole o código no Pegasus Agent.')
  ...
  const approve = async () => {
    ...
    try {
      ...
      setStatus('Pareamento aprovado. Cole o código no Agent para concluir. Ele expira em cinco minutos e só pode ser usado uma vez.')
